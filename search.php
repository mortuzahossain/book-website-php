...
<?php
    ...
    $sql = "SELECT id,name,writter,rcount,size,image FROM books WHERE CONCAT(name,writter,uploader,description) LIKE '%".$search_key."%' LIMIT $startpage,".POST_PER_PAGE;
...
<?php
    $sql = "SELECT id FROM books  WHERE CONCAT(name,writter,uploader,description) LIKE '%".$search_key."%'";
